...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://localhost:3000", "http://localhost:3001", "https://smart-resume-backend.onrender.com", "https://smart-resume-screener-jee0.onrender.com", "https://smart-resume-screener.vercel.app"],
